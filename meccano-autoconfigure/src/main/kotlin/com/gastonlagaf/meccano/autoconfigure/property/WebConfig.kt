package com.gastonlagaf.meccano.autoconfigure.property

import org.springframework.boot.context.properties.ConfigurationProperties
import org.springframework.stereotype.Component
import org.springframework.validation.annotation.Validated

@ConfigurationProperties(value = "meccano", ignoreUnknownFields = true)
@Validated
@Component
class WebConfig(
    val port: Int = 8080,
...
class SessionConfig(
    var cookieName: String = "MECCANO_DROPDOWN_IS_EXPANDED",
